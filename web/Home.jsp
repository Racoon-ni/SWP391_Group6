                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="product-list" data-aos="fade-up">
                                                            <div class="row d-flex flex-wrap align-items-stretch">
                                                                <% List<Book> list4B = (List<Book>)
                                                                        request.getAttribute("list4B");
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="product-item">
                                                                                ...
                                                                                <figcaption>
                                                                                    <h3><a
                                                                                            href="BookDetail.jsp?book_id=<%= book.getBook_id() %>">
                                                                                            <%= book.getTitle() %>
                                                                                        </a></h3>
                                                                                    <span>
                                                                                        <%= book.getAuthorName() %>
                                                                        ...
                                                                        <% } } else { %>
                                                                            <p class="text-center">No featured books
                                                                                available.</p>
                                                                            <% } %>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <ul class="tabs">
                                                            ...
                                                            <% List<Category> topCategories = (List<Category>)
                                                                    ...
                                                                    %>
                                                                    <li data-tab-target="#<%= category.getCategoryName().toLowerCase().replaceAll("
                                                                        \\s+", "-" ) %>" class="tab">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div id="all-genre" data-tab-content class="active">
                                                                <div class="row">
                                                                    <% List<Book> list8Book = (List<Book>)
                                                                            request.getAttribute("list8Book");
                                                                            if (list8Book != null &&
                                                                            !list8Book.isEmpty()) {
                                                                            ...
                                                                            <% } } else { %>
                                                                                <p class="text-center">No books
                                                                                    available.</p>
                                                                                <% } %>
                                                                </div>
                                                            </div>
                                                            <!-- Books by Category -->
                                                            <% Map<Integer, List<Book>> booksByCategory = (Map<Integer,
                                                                    List<Book>>)
                                                                    request.getAttribute("booksByCategory");
                                                                    if (topCategories != null) {
                                                                    for (Category category : topCategories) {
                                                                    List<Book> books =
                                                                        booksByCategory.get(category.getCategoryId());
                                                                        %>
                                                                        <div id="<%= category.getCategoryName().toLowerCase().replaceAll("
                                                                            \\s+", "-" ) %>" data-tab-content>
                                                                            <div class="row">
