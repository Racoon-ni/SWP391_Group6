                ...
                <%@page import="entity.Category" %>
                    <%@page import="java.util.List" %>
                        ...
                        <% CategoryDAO categoryDAO=new CategoryDAO(); List<Category> categories =
                            ...
                            request.setAttribute("totalCategories", categories.size()); // Tính tổng số danh mục ngay
                            trong Java
                            %>
                                    ...
                                    <div class="top-content">
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div
                                                        class="right-element d-flex align-items-center justify-content-end gap-2">
                                                        <c:if test="${empty sessionScope.account}">
                                                            <a href="Login.jsp"
                                                                class="user-account for-buy d-flex align-items-center">
                                                                <i class="fa-solid fa-user"></i><span
                                                                    class="ms-1">Login</span>
                                                            </a>
                                                        </c:if>
                                                ...
                                                <div class="col-auto">
                                                    <div class="main-logo">
                                                        <a href="index.jsp" class="navbar-brand ms-4 ms-lg-0">
                                                            <h1 class="fw-bold text-primary m-0">Book<span
                                                                    class="text-secondary"> Store</span></h1>
                                                        </a>
                                                    </div>
                                                </div>
                                                                ...
                                                                <li class="menu-item has-sub">
                                                                    ...
                                                                    <ul class="mega-menu">
                                                                        <div class="menu-row">
                                                                            ...
                                                                            <c:set var="numColumns"
                                                                                value="${(totalCategories / itemsPerColumn) + (totalCategories % itemsPerColumn == 0 ? 0 : 1)}" />

                                                                            <c:forEach var="cate" items="${categories}"
                                                                                varStatus="status">
                                                                                <c:if
                                                                                    test="${status.index % itemsPerColumn == 0}">
                                                                                    <div class="menu-column">
                                                                                        <!-- Mở cột mới -->
                                                                                </c:if>

                                                                                <li><a
                                                                                        href="AllBook.jsp?category=${cate.categoryId}">${cate.categoryName}</a>
                                                                                </li>

                                                                                <c:if
                                                                                    test="${status.index % itemsPerColumn == itemsPerColumn - 1 or status.last}">
                                                                        </div> <!-- Đóng cột -->
                                                                        </c:if>
                                                                        </c:forEach>
                                                        </div>
