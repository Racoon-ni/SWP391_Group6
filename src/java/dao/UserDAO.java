...
public class UserDAO {
    ...
    public boolean updateUser(int accountId, String full_name, String phone, String address, String image)
    ...
    public int insertAccount(User user) throws ClassNotFoundException {
        String sql = "INSERT INTO Account (username, password, email, role,status) VALUES (?, ?, ?, ?,1)";
